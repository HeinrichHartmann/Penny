...
def test_extract_payee_auftraggeber():
    text = "Auftraggeber: AMAZON PAYMENTS EUROPE S.C.A. Buchungstext: 028-7214985 Ref. 9L2C28W229"
    assert extract_payee(text) == "AMAZON PAYMENTS EUROPE S.C.A."


def test_extract_memo():
    text = "Auftraggeber: AMAZON Buchungstext: 028-7214985-6053918 AMZN Mktp DE Ref. 9L2C28W229"
